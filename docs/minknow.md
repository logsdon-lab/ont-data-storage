...
1. "Start"
2. "Start Sequencing" or "Start from a sample sheet"
3. Fill information in "1. Positions" tab and continue to "2. Kit"
4. Once "Kit" is chosen, a note should appear in the bottom of the screen: “Default run settings have been applied from the file `/home/prom/.config/minknow/run_config.json`.
